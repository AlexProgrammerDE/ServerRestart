package me.xginko.serverrestart.velocity.commands;
...
public class VelocityRestartsCmd {
    ...
    private final @NotNull ServerRestartVelocity plugin;
    private final @NotNull CommandManager commandManager;

    public VelocityRestartsCmd(@NotNull ServerRestartVelocity plugin, @NotNull CommandManager commandManager) {
        this.plugin = plugin;
